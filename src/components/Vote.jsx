            ...
            <Col xs={12} lg={9}>
                ...
                >
                    <p style={{ fontSize: '20px' }}>
                        ...
                        (which includes the construction of a new high school) through a special referendum. While the deadline for voter registration
                        has passed,{' '}
                    ...
                    <p style={{ fontSize: '20px' }}>
                        Vote By Mail ballots are already postage paid, so you can drop it in a USPS mailbox, at the post office or in the ballot drop
                        box at City Hall.{' '}
                        <span style={{ color: '#ba0001', fontWeight: 'bold' }}>
